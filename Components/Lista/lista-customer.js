import { deleteData, getDataAll,searchDataById,opc,putData } from "../../Apis/customer-api.js";

export class ListaCustomer extends HTMLElement {
    constructor(){
        super();
        this.render();
    ...
    loadDataFrm(data){
        console.log(data);
        const myForm = document.querySelector("#editarClienteFrom");
...
customElements.define("lista-customer",ListaCustomer);